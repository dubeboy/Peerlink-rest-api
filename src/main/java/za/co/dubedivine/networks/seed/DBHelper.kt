...
class DBHelper(private val questionRepository: QuestionRepository) : CommandLineRunner {
    ...
    override fun run(vararg strings: String) {
       val questionA: Question = Question("what is an Atom",
               "people are telling me diffrent things about an atom bro please help me!",
        ...
        questionA.comments = arrayListOf(Comment("did u try googling this?", 0), Comment("we would expect you to know this bro!", 2))
        ...
        val questionB: Question = Question("What is magnetic flux",
                ...
                "QUESTION")
        questionB.answers = arrayListOf( Answer("the magnetic flux is the force field around a magnet", 300, true),
                Answer("the magnetic flux is the name of invisible force that the magnet has on objects", 60, false))
